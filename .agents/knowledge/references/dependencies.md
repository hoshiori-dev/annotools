...
| numpy | 2.5.2 | https://numpy.org/doc | `image/segmentation.py`, `geometry.py` |
...
| s3fs / gcsfs / aiohttp / requests (extra `remote`) | 2026.7.0 / 2026.8.0 | fsspec implementations | remote URLs in `io.py` |
