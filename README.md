...
Under construction — milestone P1 (core library and image tools). The five image preview tools, `color_from_text`, and `rotated_bbox_to_polygon` are available; segmentation, video, and audio tools are planned. Follow
