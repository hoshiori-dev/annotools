...
| Check | Command |
|---|---|
| Everything CI requires on a PR (lint, format, types, taxonomy, README sync, unit tests with the 95 % coverage gate, public docstrings, strict docs build) | `just check` |
...
| Public API docstrings complete | `just check-docs` |
