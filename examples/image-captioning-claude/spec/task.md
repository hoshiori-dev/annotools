...
## Budget
- `max_budget_usd_per_item` 0.25 (SDK client-side estimate, enforced per query; a successful item costs
  about 0.10 and the estimate at the first tool result is already about 0.16); ≤ 4 workers; stop the run after
